...
{
    [Table("view_TreeNSI_IndustrialUnitModule")]
    [DefaultClassOptions]
    public class vIndustrialUnitModule
    {
        [Key]
        [ForeignKey("IndustrialUnitModule")]
        ...
        public virtual IndustrialUnitModule IndustrialUnitModule { get; set; }
    }
}
