...
{
    [Table("TreeNSI_IndustrialUnitProperty")]
    [DefaultClassOptions]
    public class IndustrialUnitProperty : IXafEntityObject, IObjectSpaceLink
    {
        [Key]
        ...
        [RuleRequiredField(DefaultContexts.Save)]
        public virtual IndustrialUnit Element { get; set; }
