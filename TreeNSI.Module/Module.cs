...
namespace TreeNSI.Module {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/clsDevExpressExpressAppModuleBasetopic.aspx.
    public sealed partial class TreeNSIModule : ModuleBase {
        static TreeNSIModule() {
...
//#if DEBUG
//            Database.SetInitializer(new DropCreateDatabaseIfModelChanges<TreeNSIDbContext>());
//#endif
        }
        public TreeNSIModule() {
            InitializeComponent();
